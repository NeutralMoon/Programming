...
Для работы с графическими возможностями Python использовались две библиотеки: `Tkinter` и `Pillow`, первое из которых позволяет создавать различные компоненты графического интерфейса пользователя. В приложении это пригодилось для создания различных кнопок и надписей. В то время как `Pillow` обладает функционалом для работы с растровыми изображениями.

Для работы с изображениями был написан вспомогательный модуль `imgutils`, позволяющий с помощью библиотеки `Pillow` открывать, трансформировать и совмещать изображения игры. 
...
### 4. Алгоритм поиска короткого пути
...
## Вывод
Разработал игру на языке Python, получил навыки в разработке игр на языке Python.